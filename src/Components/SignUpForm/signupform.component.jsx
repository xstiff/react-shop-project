...
const SignUp = () =>{
    ...
    const handleSubmit = async (event) => {
        ...
        if( !(formFields.password == formFields.confirmPassword) ) return(alert('password doesnt match'));

        if(password.length < 6) return(alert('password should be at least 6 characters long'))
